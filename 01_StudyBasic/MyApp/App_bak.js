...
function HomeScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('mainOne', {status:''})}>
      <BottomButtonView/>
      </TouchableOpacity>
...
function mainOne({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => navigation.navigate('mainTwo')}>
      <BottomButtonView/>
        </TouchableOpacity>
      </View>
    </View>
...
function mainTwo({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => navigation.navigate('mainThree')}>
      <BottomButtonView/>
        </TouchableOpacity>
      </View>
    </View>
...
function mainThree({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
      <TouchableOpacity onPress={() => navigation.navigate('q1_Start')}>
      <BottomButtonView/>
        </TouchableOpacity>
      </View>
    </View>
    ...
    <View  style={{width:"100%", left:0, right:0, flexDirection:"row"}}>
        ...
        <ScrollView style={{paddingHorizontal: 20,}}>
          ...
          <TextInput 
                  ...
                  style={{height: 40, margin:20, padding:5, borderRadius:8, borderWidth: 1}}
                  placeholder="10점만점"
...
function last_page({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('last_page_Q1')}>
      <BottomButtonView/>
      </TouchableOpacity>
    </View>
  );
  ...
  return (
    ...
    <View style={styles.mainviewStyle}>
        <ScrollView style = {styles.scrollViewStyle}>
          ...
          <Button
            title="확인하기" onPress={() => navigation.navigate('last_page_QE')}
          />
